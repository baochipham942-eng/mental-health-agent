...
export default function Loading() {
    return (
        <div className="flex h-full flex-col bg-white">
            {/* Header Skeleton */}
            <div className="flex h-16 items-center border-b border-gray-200 px-4 bg-white/80 backdrop-blur-sm sticky top-0 z-10">
            ...
            <div className="flex-1 overflow-hidden p-4 space-y-6">
                ...
                <div className="flex justify-start">
                    <div className="h-24 w-full max-w-3xl bg-white border border-gray-100 shadow-sm rounded-2xl rounded-tl-none p-4 animate-pulse">
