...
export default function UsersPage() {
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <div className="flex items-center gap-2">
                            ...
                            {record.isAdmin && (
                                <Tag size="small" color="red">管理员</Tag>
                            )}
                        </div>
    ...
    function handleTableChange(_: any, sorter: any) {
        if (sorter) {
    ...
    return (
        <div className="h-full overflow-y-auto bg-linear-to-br from-gray-50 to-indigo-50">
