...
// Phase 3 Fix: 扩展包含"被 + 动词"的结构及常见负面互动动词
const RE_EVENT = /(被.*?(骂|批评|否定|催|开|辞|pua|PUA|骗|质疑|打击|强迫|欺负|羞辱|嘲笑|冷落|排挤|忽略)|让|叫|说|骂|批评|安排|催|逼|改|加班|开会|对接|汇报|延期|出错|锅|被|想离职|想辞职|骗|强迫|质疑|打击|拒绝)/;
